...
#define BASE_URL "https://api.thingspeak.com/update?"
#define FIELD_USERNAME "Louis"
...
int main(int argc, char *argv[])
{
    ...
    // Construct the POST data with username and message
    char post_data[256];
    snprintf(post_data, sizeof(post_data), "api_key=%s&field1=%s&field2=%s", API_KEY, FIELD_USERNAME, argv[1]);
